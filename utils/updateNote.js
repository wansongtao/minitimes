...
/**
 * @description 更新笔记数据文件内容(删除原文件)
 * @param {Object} oldVal 需要更新的项
 * @param {Object} newVal 新项
 * @returns {Boolean} 成功true，失败false
 */
const updateNoteFile = (oldVal, newVal) => {
  if (!verifyNoteFormat(oldVal, separator) || !verifyNoteFormat(newVal, separator)) {
